                      ...
                      GParamSpec      *pspec)
{
    ...
    case PROP_PDF_DIRNAME:
        qof_instance_get_kvp (QOF_INSTANCE (job), value, OWNER_EXPORT_PDF_DIRNAME);
        break;
    default:
                      ...
                      GParamSpec      *pspec)
{
    ...
    case PROP_NAME:
        ...
        break;
    case PROP_PDF_DIRNAME:
        qof_instance_set_kvp (QOF_INSTANCE (job), value, OWNER_EXPORT_PDF_DIRNAME);
        break;
    default:
        G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec);
        break;
...
void gncJobSetRate (GncJob *job, gnc_numeric rate)
{
    ...
    if (!gnc_numeric_zero_p(rate))
    {
        ...
        qof_instance_set_kvp (QOF_INSTANCE (job), &v, GNC_JOB_RATE);
    }
    else
    {
        qof_instance_set_kvp (QOF_INSTANCE (job), NULL, GNC_JOB_RATE);
    }
    mark_job (job);
    gncJobCommitEdit (job);
}
...
gnc_numeric gncJobGetRate (const GncJob *job)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (job), &v, GNC_JOB_RATE);
