...
gnc_lot_get_property(GObject* object, guint prop_id, GValue* value, GParamSpec* pspec)
{
    ...
    case PROP_MARKER:
        ...
        break;
    case PROP_INVOICE:
        qof_instance_get_kvp (QOF_INSTANCE (lot), value, GNC_INVOICE_ID GNC_INVOICE_GUID);
        break;
    case PROP_OWNER_TYPE:
        qof_instance_get_kvp (QOF_INSTANCE (lot), value, GNC_OWNER_ID GNC_OWNER_TYPE);
        break;
    case PROP_OWNER_GUID:
        qof_instance_get_kvp (QOF_INSTANCE (lot), value, GNC_OWNER_ID GNC_OWNER_GUID);
        break;
    default:
                      ...
                      GParamSpec* pspec)
{
    ...
    case PROP_MARKER:
        ...
        break;
    case PROP_INVOICE:
        qof_instance_set_kvp (QOF_INSTANCE (lot), value, GNC_INVOICE_ID GNC_INVOICE_GUID);
        break;
    case PROP_OWNER_TYPE:
        qof_instance_set_kvp (QOF_INSTANCE (lot), value, GNC_OWNER_ID GNC_OWNER_TYPE);
        break;
    case PROP_OWNER_GUID:
        qof_instance_set_kvp (QOF_INSTANCE (lot), value, GNC_OWNER_ID GNC_OWNER_GUID);
        break;
    default:
        G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec);
        break;
...
gnc_lot_get_title (const GNCLot *lot)
{
    ...
    if (!lot) return NULL;
    qof_instance_get_kvp (QOF_INSTANCE (lot), &v, "title");
...
gnc_lot_get_notes (const GNCLot *lot)
{
    GValue v = G_VALUE_INIT;
    if (!lot) return NULL;
    qof_instance_get_kvp (QOF_INSTANCE (lot), &v, "notes");
    if (G_VALUE_HOLDS_STRING (&v))
        return g_value_get_string (&v);
    return NULL;
}
...
gnc_lot_set_title (GNCLot *lot, const char *str)
{
    ...
    qof_instance_set_kvp (QOF_INSTANCE (lot), &v, "title");
...
gnc_lot_set_notes (GNCLot *lot, const char *str)
{
    ...
    g_value_init (&v, G_TYPE_STRING);
    g_value_set_string (&v, str);
    qof_instance_set_kvp (QOF_INSTANCE (lot), &v, "notes");
    qof_instance_set_dirty(QOF_INSTANCE(lot));
    gnc_lot_commit_edit(lot);
}
