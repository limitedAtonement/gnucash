                             ...
                             GParamSpec* pspec)
{
    ...
    case PROP_ENTER_DATE:
        ...
        break;
    case PROP_INVOICE:
        qof_instance_get_kvp (QOF_INSTANCE (tx), value, GNC_INVOICE_ID GNC_INVOICE_GUID);
        break;
    case PROP_SX_TXN:
        qof_instance_get_kvp (QOF_INSTANCE (tx), value, GNC_SX_FROM);
        break;
    case PROP_ONLINE_ACCOUNT:
        qof_instance_get_kvp (QOF_INSTANCE (tx), value, "online_id");
        break;
    default:
                             ...
                             GParamSpec* pspec)
{
    ...
    case PROP_ENTER_DATE:
        ...
        break;
    case PROP_INVOICE:
        qof_instance_set_kvp (QOF_INSTANCE (tx), value, GNC_INVOICE_ID GNC_INVOICE_GUID);
        break;
    case PROP_SX_TXN:
        qof_instance_set_kvp (QOF_INSTANCE (tx), value, GNC_SX_FROM);
        break;
    case PROP_ONLINE_ACCOUNT:
        qof_instance_set_kvp (QOF_INSTANCE (tx), value, "online_id");
        break;
    default:
        G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec);
        break;
...
xaccTransSetDatePostedGDate (Transaction *trans, GDate date)
{
    ...
    qof_instance_set_kvp (QOF_INSTANCE(trans), &v, TRANS_DATE_POSTED);
...
xaccTransSetDateDueTS (Transaction *trans, const Timespec *ts)
{
    ...
    xaccTransBeginEdit(trans);
    qof_instance_set_kvp (QOF_INSTANCE (trans), &v, TRANS_DATE_DUE_KVP);
    qof_instance_set_dirty(QOF_INSTANCE(trans));
    xaccTransCommitEdit(trans);
}
...
xaccTransSetTxnType (Transaction *trans, char type)
{
    ...
    xaccTransBeginEdit(trans);
    qof_instance_set_kvp (QOF_INSTANCE (trans), &v, TRANS_TXN_TYPE_KVP);
    qof_instance_set_dirty(QOF_INSTANCE(trans));
    xaccTransCommitEdit(trans);
}
...
void xaccTransClearReadOnly (Transaction *trans)
{
    ...
    {
        xaccTransBeginEdit(trans);
        qof_instance_set_kvp (QOF_INSTANCE (trans), NULL, TRANS_READ_ONLY_REASON);
        qof_instance_set_dirty(QOF_INSTANCE(trans));
        xaccTransCommitEdit(trans);
    }
}
...
xaccTransSetReadOnly (Transaction *trans, const char *reason)
{
    if (trans && reason)
    {
        ...
        xaccTransBeginEdit(trans);
        qof_instance_set_kvp (QOF_INSTANCE (trans), &v, TRANS_READ_ONLY_REASON);
        qof_instance_set_dirty(QOF_INSTANCE(trans));
        xaccTransCommitEdit(trans);
    }
}
...
xaccTransSetAssociation (Transaction *trans, const char *assoc)
{
    ...
    xaccTransBeginEdit(trans);
    qof_instance_set_kvp (QOF_INSTANCE (trans), &v, assoc_uri_str);
    qof_instance_set_dirty(QOF_INSTANCE(trans));
    xaccTransCommitEdit(trans);
}
...
xaccTransSetNotes (Transaction *trans, const char *notes)
{
    ...
    qof_instance_set_kvp (QOF_INSTANCE (trans), &v, trans_notes_str);
    qof_instance_set_dirty(QOF_INSTANCE(trans));
    xaccTransCommitEdit(trans);
}
...
xaccTransSetIsClosingTxn (Transaction *trans, gboolean is_closing)
{
    ...
    if (is_closing)
    {
        ...
        qof_instance_set_kvp (QOF_INSTANCE (trans), &v, trans_is_closing_str);
    }
    else
        qof_instance_set_kvp (QOF_INSTANCE (trans), NULL, trans_is_closing_str);
    qof_instance_set_dirty(QOF_INSTANCE(trans));
    xaccTransCommitEdit(trans);
}
...
xaccTransGetAssociation (const Transaction *trans)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, assoc_uri_str);
...
xaccTransGetNotes (const Transaction *trans)
{
    GValue v = G_VALUE_INIT;
    if (!trans) return NULL;
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, trans_notes_str);
    if (G_VALUE_HOLDS_STRING (&v))
         return g_value_get_string (&v);
    return NULL;
}
...
xaccTransGetIsClosingTxn (const Transaction *trans)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, trans_is_closing_str);
...
xaccTransGetDatePostedGDate (const Transaction *trans)
{
    ...
    if (trans)
    {
         ...
         * shifts. */
        GValue v = G_VALUE_INIT;
        qof_instance_get_kvp (QOF_INSTANCE (trans), &v, TRANS_DATE_POSTED);
...
xaccTransGetDateDueTS (const Transaction *trans, Timespec *ts)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, TRANS_DATE_DUE_KVP);
    if (G_VALUE_HOLDS_BOXED (&v))
...
xaccTransGetTxnType (const Transaction *trans)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, TRANS_TXN_TYPE_KVP);
    if (G_VALUE_HOLDS_STRING (&v))
...
xaccTransGetReadOnly (const Transaction *trans)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE(trans), &v, TRANS_READ_ONLY_REASON);
    if (G_VALUE_HOLDS_STRING (&v))
         s = g_value_get_string (&v);
    if (s && strlen (s))
        return s;
...
xaccTransVoid(Transaction *trans, const char *reason)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, trans_notes_str);
    if (G_VALUE_HOLDS_STRING (&v))
        qof_instance_set_kvp (QOF_INSTANCE (trans), &v, void_former_notes_str);
    else
        g_value_init (&v, G_TYPE_STRING);
    ...
    qof_instance_set_kvp (QOF_INSTANCE (trans), &v, trans_notes_str);
    g_value_set_string (&v, reason);
    qof_instance_set_kvp (QOF_INSTANCE (trans), &v, void_reason_str);

    gnc_timespec_to_iso8601_buff (timespec_now (), iso8601_str);
    g_value_set_string (&v, iso8601_str);
    qof_instance_set_kvp (QOF_INSTANCE (trans), &v, void_time_str);
...
xaccTransGetVoidStatus(const Transaction *trans)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, void_reason_str);
    if (G_VALUE_HOLDS_STRING (&v))
         s = g_value_get_string (&v);
    return s && strlen(s);
}
...
xaccTransGetVoidTime(const Transaction *tr)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (tr), &v, void_time_str);
    if (G_VALUE_HOLDS_STRING (&v))
        s = g_value_get_string (&v);
    if (s)
...
xaccTransUnvoid (Transaction *trans)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (trans), &v, void_former_notes_str);
    if (G_VALUE_HOLDS_STRING (&v))
        qof_instance_set_kvp (QOF_INSTANCE (trans), &v, trans_notes_str);
    qof_instance_set_kvp (QOF_INSTANCE (trans), NULL, void_former_notes_str);
    qof_instance_set_kvp (QOF_INSTANCE (trans), NULL, void_reason_str);
    qof_instance_set_kvp (QOF_INSTANCE (trans), NULL, void_time_str);
...
xaccTransReverse (Transaction *orig)
{
    ...
    qof_instance_set_kvp (QOF_INSTANCE (orig), &v, TRANS_REVERSED_BY);
...
xaccTransGetReversedBy(const Transaction *trans)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE(trans), &v, TRANS_REVERSED_BY);
    if (G_VALUE_HOLDS_BOXED (&v))
