                       ...
                       GParamSpec      *pspec)
{
    ...
    switch (prop_id)
    {
        ...
        case PROP_SX_CREDIT_FORMULA:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_CREDIT_FORMULA);
            break;
        case PROP_SX_CREDIT_NUMERIC:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_CREDIT_NUMERIC);
            break;
        case PROP_SX_DEBIT_FORMULA:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_DEBIT_FORMULA);
            break;
        case PROP_SX_DEBIT_NUMERIC:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_DEBIT_NUMERIC);
            break;
        case PROP_SX_ACCOUNT:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_ACCOUNT);
            break;
        case PROP_SX_SHARES:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_SHARES);
            break;
        case PROP_ONLINE_ACCOUNT:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, "online_id");
            break;
        case PROP_GAINS_SPLIT:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, "gains-split");
            break;
        case PROP_GAINS_SOURCE:
            qof_instance_get_kvp (QOF_INSTANCE (split), value, "gains-source");
            break;
        default:
                       ...
                       GParamSpec      *pspec)
{
    ...
    switch (prop_id)
    {
        ...
        case PROP_LOT:
            ...
            break;
        case PROP_SX_CREDIT_FORMULA:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_CREDIT_FORMULA);
            break;
        case PROP_SX_CREDIT_NUMERIC:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_CREDIT_NUMERIC);
            break;
        case PROP_SX_DEBIT_FORMULA:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_DEBIT_FORMULA);
            break;
        case PROP_SX_DEBIT_NUMERIC:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_DEBIT_NUMERIC);
            break;
        case PROP_SX_ACCOUNT:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_ACCOUNT);
            break;
        case PROP_SX_SHARES:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, GNC_SX_ID GNC_SX_SHARES);
            break;
        case PROP_ONLINE_ACCOUNT:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, "online_id");
            break;
        case PROP_GAINS_SPLIT:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, "gains-split");
            break;
        case PROP_GAINS_SOURCE:
            qof_instance_set_kvp (QOF_INSTANCE (split), value, "gains-source");
            break;
        default:
            G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec);
            break;
...
xaccSplitDetermineGainStatus (Split *split)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (split), &v, "gains-source");
...
xaccSplitGetType(const Split *s)
{
    ...
    if (!s) return NULL;
    qof_instance_get_kvp (QOF_INSTANCE (s), &v, "split-type");
...
xaccSplitMakeStockSplit(Split *s)
{
    ...
    qof_instance_set_kvp (QOF_INSTANCE (s), &v, "split-type");
    SET_GAINS_VDIRTY(s);
    mark_split(s);
    qof_instance_set_dirty(QOF_INSTANCE(s));
    xaccTransCommitEdit(s->parent);
...
xaccSplitVoidFormerAmount(const Split *split)
{
    ...
    qof_instance_get_kvp (QOF_INSTANCE (split), &v, void_former_amt_str);
    if (G_VALUE_HOLDS_BOXED (&v))
...
xaccSplitVoidFormerValue(const Split *split)
{
    ...
    gnc_numeric *num = NULL;
    g_return_val_if_fail(split, gnc_numeric_zero());
    qof_instance_get_kvp (QOF_INSTANCE (split), &v, void_former_val_str);
    if (G_VALUE_HOLDS_BOXED (&v))
        num = (gnc_numeric*)g_value_get_boxed (&v);
    return num ? *num : gnc_numeric_zero();
}
...
xaccSplitVoid(Split *split)
{
    ...
    qof_instance_set_kvp (QOF_INSTANCE (split), &v, void_former_amt_str);
    num =  xaccSplitGetValue(split);
    g_value_set_boxed (&v, &num);
    qof_instance_set_kvp (QOF_INSTANCE (split), &v, void_former_val_str);
...
xaccSplitUnvoid(Split *split)
{
    ...
    qof_instance_set_kvp (QOF_INSTANCE (split), NULL, void_former_amt_str);
    qof_instance_set_kvp (QOF_INSTANCE (split), NULL, void_former_val_str);
    qof_instance_set_dirty (QOF_INSTANCE (split));
}
